...
/**
 * The DAO Layer class implement the Proxy Design Pattern.
 */
...
public class MobileContactDaoImpl implements IMobileContactDao {
    ...
    /**
     * Returns the position in the ArrayList datasource of the {@link MobileContact} containing the <code>id</code>.
     * @param id                the {@link MobileContact#id} to be searched.
     * @return                  the resulting position or -1 if the id will not be found
     */
    ...
    /**
     * Returns the position in the ArrayList datasource of the {@link MobileContact} containing the <code>phoneNumber</code>.
     * @param phoneNumber                the {@link MobileContact#phoneNumber} to be searched.
     * @return                  the resulting position or -1 if the phoneNumber will not be found
     */
